...
$latencyJobs = Invoke-FireAndForget -Seconds 120 -Concurrency 30 -Mode "LATENCY" -DelayMs 600 -ForceError $false
$latencyTtd = Wait-ConditionTrue -PrometheusUrl $PrometheusUrl -Query $latencyQuery -TimeoutSec 240 -PollSec 5
...
$errorJobs = Invoke-FireAndForget -Seconds 90 -Concurrency 20 -Mode "ERROR" -DelayMs 0 -ForceError $true
$errorTtd = Wait-ConditionTrue -PrometheusUrl $PrometheusUrl -Query $errorQuery -TimeoutSec 240 -PollSec 5
